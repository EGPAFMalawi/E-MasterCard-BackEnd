...
use App\Modules\Core\Locations\Clients\API\Routes\APIv1Router;
...
class RouteServiceProvider extends ServiceProvider
{
  ...
  protected $namespaces = [
        'api' => 'App\Modules\Core\Locations\Clients\API\Controllers'
    ];
  ...
  public function registerRouteBindings()
  {
      Route::bind('Location',function ($value){
          $location = App::make(LocationRepository::class)->get($value);

          return $location?$location : abort(404, 'Location not found');
      });
  }
