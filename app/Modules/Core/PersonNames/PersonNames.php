...
use App\Modules\Core\PersonNames\Processing\Actions\UpdatePersonNameAction;
...
class PersonNames{
    ...
    public static function update($data, PersonName $personName)
    {
        return App::make(UpdatePersonNameAction::class)->run($data, $personName);
    }
