...
use App\Modules\Core\Regions\Clients\API\Routes\APIv1Router;
...
class RouteServiceProvider extends ServiceProvider
{
  ...
  protected $namespaces = [
        'api' => 'App\Modules\Core\Regions\Clients\API\Controllers'
    ];
  ...
  public function registerRouteBindings()
  {
      Route::bind('Region',function ($value){
          $region = App::make(RegionRepository::class)->get($value);

          return $region?$region : abort(404, 'Region not found');
      });
  }
